...
export default function page() {
  ...
  const [isInstanceDataModalOpen, setIsInstanceDataModalOpen] =
  ...
  return (
    <div className="p-4 h-full">
      <div className="bg-white dark:bg-gray-900 shadow-lg rounded-lg border border-gray-200 dark:border-gray-700 h-full">
        <div className="flex items-center justify-between p-2 px-3">
          <h1 className="text-lg font-semibold text-gray-900 dark:text-white">
            {decodeURIComponent(paramsData.myTask).split("/")[1]}
          </h1>
      ...
      />
      <MyTaskInstanceModal
        isOpen={isInstanceDataModalOpen}
        setModal={setIsInstanceDataModalOpen}
        instanceEntryData={instanceEntryData}
      />
