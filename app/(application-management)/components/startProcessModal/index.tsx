...
const ProcessModal = () => {
  ...
  const [processInstanceIdentifierFields, setProcessInstanceIdentifierFields] = useState('');
  ...
  return (
    <div className="p-8">
          ...
          <div className="space-y-6 py-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setProcessInstanceIdentifierFields(e.target.value)}
      ...
      <div className="mt-8 p-4 bg-gray-50 rounded-lg">
        <h3 className="text-lg font-medium text-gray-900 mb-2">Try Some Sample JSON:</h3>
        <div className="space-y-2">
          <Button
            variant="outline"
            onClick={() => handleDataChange('{"name": "John Doe", "age": 30, "active": true}')}
            className="text-sm"
          >
            Sample User Data
          </Button>
          <Button
            variant="outline"
            onClick={() => handleDataChange('{"process": "approval", "status": "pending", "priority": "high", "metadata": {"department": "finance", "amount": 1500}}')}
